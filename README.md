...
- **The Studio** follows the WordPress model: a Sites list opens into an editor where
  the canvas is the main view. The right sidebar has "Page" (Yoast-style SEO panels:
  SERP preview, snippet editor, traffic-light analysis, social, indexing, structured
  data) and "Field" (the inspector for the selected element). Preview is a canvas
  mode; Export ZIP produces the static site.

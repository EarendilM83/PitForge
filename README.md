...
- **The Studio** has three tabs — Edit (outlines, in-place text editing, inspectors,
  undo, autosave), Preview (the honest static render), SEO (every §10.1 field, SERP +
  social previews, checks, Advanced head drawer) — plus Download ZIP.

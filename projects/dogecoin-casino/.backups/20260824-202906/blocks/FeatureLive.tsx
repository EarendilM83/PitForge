...
import { PFText, PFImage, PFIcon, PFRepeat, PFButton } from '../../../src/runtime/components';
              ...
              {(item, index) => (
                <div className={index === 0 ? 'fl-item fl-item--open' : 'fl-item'}>
                  <div className="fl-item-head">
                    <PFText field={`${item}.title`} className="fl-item-title" />
                    <span className="fl-item-icon" aria-hidden>
                      <PFIcon field={`${item}.icon`} />
                    </span>
                  </div>
